...
1. Clone the repo **recursively**:
    ...
    ```
1. Download [SDL2-2.24.2.dmg](https://libsdl.org/release/SDL2-2.24.2.dmg), open it, and copy **SDL2.framework** to the **extern** folder
...
1. Clone the repo **recursively**:
    ...
    git clone --recurse-submodules https://github.com/jorio/Nanosaur2
    ```
1. Download [SDL2-devel-2.24.2-VC.zip](https://libsdl.org/release/SDL2-devel-2.24.2-VC.zip) and extract the contents into the **extern** folder
