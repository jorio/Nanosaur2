...
{
	MO_TYPE_GROUP		SWIFT_NAME(group)		= 	'grup',
	MO_TYPE_GEOMETRY	SWIFT_NAME(geometry)	=	'geom',
	MO_TYPE_MATERIAL	SWIFT_NAME(material)	=	'matl',
	MO_TYPE_MATRIX		SWIFT_NAME(matrix)		=	'mtrx',
	MO_TYPE_PICTURE		SWIFT_NAME(picture)		=	'pict',
	MO_TYPE_SPRITE		SWIFT_NAME(sprite)		=	'sprt'
} MetaObjectType;
