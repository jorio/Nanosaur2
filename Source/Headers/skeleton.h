...
{
	ACCEL_MODE_LINEAR SWIFT_NAME(ACCEL_MODE_LINEAR),
	ACCEL_MODE_EASEINOUT SWIFT_NAME(ACCEL_MODE_EASEINOUT),
	ACCEL_MODE_EASEIN SWIFT_NAME(ACCEL_MODE_EASEIN),
	ACCEL_MODE_EASEOUT SWIFT_NAME(ACCEL_MODE_EASEOUT)
} AccelerationMode;
